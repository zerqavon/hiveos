# Zerqavon HiveOS wrapper 1.0.6 (Miner 1.0.4)
...
Version 1.0.6 adds compatibility with legacy HiveOS custom-miner launchers, which source `h-config.sh` without explicitly calling the configuration generator. It also retains the LF line-ending fix introduced in 1.0.5.
...
- Installation URL: `https://github.com/zerqavon/hiveos/releases/download/v1.0.6/zerqavon-miner-1.0.6.tar.gz`
